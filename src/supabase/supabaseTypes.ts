  ...
  public: {
    Tables: {
      deaths_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "deaths_analytics_raw_report_id_fkey"
            columns: ["raw_report_id"]
            isOneToOne: false
            referencedRelation: "raw_reports"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "deaths_analytics_vaccine_id_fkey"
            columns: ["vaccine_id"]
            isOneToOne: false
      ...
      raw_symptoms: {
        Row: {
          ...
          unique_symptom_type_id: string | null
          vaers_id: number
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "raw_symptoms_unique_symptom_type_id_fkey"
            columns: ["unique_symptom_type_id"]
            isOneToOne: false
            referencedRelation: "unique_symptom_types"
            referencedColumns: ["id"]
          },
      ...
      unique_vaccine_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "unique_vaccine_types_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "vaccine_category"
            referencedColumns: ["id"]
          },
        ]
      }
